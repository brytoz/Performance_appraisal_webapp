...
if($id!="")
{
	$sql="select * from minzhu where id=$id";
$data=getfirst($sql);
}
if($act=="save")
{
if($p0=="")
	{
echo "<script>alert('民主名称不能为空');history.back();</script>";
	exit;
}
if($id!="")
	{
	$sql="update minzhu set name='$p0' where id=$id";
	if(mysql_query($sql))
	{
		echo "<meta http-equiv=\"refresh\" content=\"0;URL=minzhu.php\">";
		exit;
		}
	 else
	exit ("添加失败");
}
 $sql="insert into minzhu (name) values ('$p0')";
 if(mysql_query($sql))
  echo "<meta http-equiv=\"refresh\" content=\"0;URL=minzhu.php\">";
 else
	 echo "添加失败";
...
<div align="center">
  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
      <td height="30" bgcolor="#E7F3FB"><div align="center" >添加修改民主</div></td>
    </tr>
    <tr>
      <td bgcolor="#E7F3FB"><table width="780" border="0" align="center" cellpadding="0" cellspacing="1">
        ...
        <tr>
          <td height="25" bgcolor="#FFFFFF"><div align="center">民主名称</div></td>
     ...
     <tr>
      <td height="20"><div align="center" ><input type="submit" value="保存民主" class="buttoncss">&nbsp;</div></td>
    </tr>
	</form>
  </table>
</p>
